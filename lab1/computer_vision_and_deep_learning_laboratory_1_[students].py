...
img = cv2.imread('cute_cat.jpg', 0) # BGR , RGB
value = 100
img_l1 = np.where((255 - img) < value, 255, img + value)
...
img = cv2.imread('cute_cat.jpg', 0) # BGR , RGB
value = 100
img_l2 = np.where((img + 0) > value, img - value, 0)
...
# extract red channel
value = 255
img[:, :, 0] = np.where((255 - img[:, :, 0] < value), 255, img[:, :, 0] + value)
...
#
# img[:,:,2] = np.where((255 - img[:,:,2] < 200), 255, img[:,:,2] + 200)
# img = np.where((img + 0 )> 100, img - 100, 0)

imagecopy = deepcopy(img)
...
#subtract
img = np.subtract(img, [103.939, 116.779, 123.68])
...
img[:,:,0] = np.where((255 - img[:,:,0] < 200), 255, img[:,:,0] + 200)
img = np.where((img + 0 )> 100, img - 100, 0)
